...
import { Trophy, Printer, RotateCcw, Mountain, Download, Upload } from 'lucide-react';
import { adaptChallengesToTableFormat } from '../../utils/challengeAdapter';
import { RANKS, LEVEL_LABELS } from '../../constants/gridConstants';
import { CompletedState, DifficultyLevel } from '../../types/gridTypes';
import ChallengeItem from './ChallengeItem';
import GridFooter from './GridFooter';

const GridTracker: React.FC = () => {
  const CATEGORIES = adaptChallengesToTableFormat();
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 lg:p-12 print:p-0 bg-stone-50">
      <div className="max-w-6xl mx-auto bg-white md:shadow-2xl md:p-12 print:shadow-none print:p-0 print:bg-white rounded-xl border border-stone-200 print:border-none min-h-[1000px]">
        ...
        <header className="mb-10 border-b-2 border-stone-900 pb-6">
          ...
          <div className="mt-8 flex flex-col md:flex-row gap-6 md:items-center justify-between bg-stone-50 p-4 rounded-lg border border-stone-200 print:border-stone-900">
